...
@section('image', isset($subSolution) && !empty($subSolution->gambar[0]->gambar) ? asset('storage/' .
    $subSolution->gambar[0]->gambar) : asset('asset/img/images/no-image1.png'))
@section('content')
    <!-- breadcrumb-area -->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="slide-container">
                                                    ...
                                                    @if ($subSolution->link_3d)
                                                        <a href="{{ $subSolution->link_3d }}" class="btn-3d"
                                                            target="_blank">
                                    ...
                                    <div class="services__details-list-two">
                                        <div class="row gutter-24">
                                            @if ($subSolution && $subSolution->fiturSubSolutions->isNotEmpty())
                                                @foreach ($subSolution->fiturSubSolutions as $fitur)
                                                    <div class="col-md-4">
                                                        <div class="services__details-list-box-two">
                                                            <div class="icon">
                                                                <img src="{{ asset('storage/' . $fitur->icon) }}"
                                                                    alt="icon">
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title">{{ $fitur->nama }}</h4>
                                                                <p style="color: #2E2E4D;text-align: center;">
                                                                    {{ $fitur->description }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <span class="project-artikel__details-inner-content">Fitur belum
                                                    tersedia.</span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row gutter-24 align-items-top">
                                    <div class="col-56">
                                        <div class="project__details-inner-content" id="project-description">
                                            @if ($subSolution)
                                                <span
                                                    class="project-artikel__details-inner-content">{!! $subSolution->description3 !!}</span>
                                            @else
                                                <span class="project-artikel__details-inner-content">Sub-solusi tidak
                                                    ditemukan.</span>
                                            @endif
                                        </div>
                                    </div>
                                            ...
                                            @if ($subSolution && $subSolution->video)
                                                ...
                                                @if ($videoId)
                                                    <div class="video-thumbnail-wrapper"
                                                        ...
                                                        <!-- Tombol Play -->
                                                        <a href="{{ $subSolution->video }}" class="play-btn popup-video"
                                                            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                                                            <i class="fas fa-play" style="font-size: 40px;"></i>
                                                        </a>
                                                    </div>
                                                @else
                                                    <span class="project-artikel__details-inner-content">Invalid YouTube
                                                        URL</span>
                                                @endif
                                            @endif
                                        </div>
                                ...
                                <div class="sidebar__cat-list-two sidebar__cat-list-three ">
                                    <ul class="list-wrap">
                                        @foreach ($solution->subSolutions as $subSolution)
                                            <li
                                                class="{{ Request::is('solusi/' . Str::slug($solution->nama) . '/' . Str::slug($subSolution->nama)) ? 'active' : '' }}">
    ...
    <section class="produk_expert__area_six">
        <div class="container">
            <div class="box-video-small">
                ...
                <div class="produk-shape-wrap">
                    <img src="{{ asset('asset/img/images/Komponen background.png') }}" alt="" data-aos="fade-right"
                        data-aos-delay="400">
                </div>
            </div>
                ...
                <div class="swiper-container produk-slider">
                                ...
                                <div>
                                    <a href="{{ route('detail-produk.show', $item->slug) }}" class="produk-item">
                                        <div class="produk-thumb">
                                            <img src="{{ asset('storage/' . $item->gambar_thumbnail_produk) }}"
                    ...
                    <div class="box-button-slider-right">
                        <div class="produk__nav-four">
                            <div class="produk-two-button-prev button-swiper-prev"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="produk-two-button-next button-swiper-next"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-right">
        ...
        <div class="produk_expert-shape-wrap">
            <img src="{{ asset('asset/img/images/Produkbackground.png') }}" alt="" data-aos="fade-right"
                data-aos-delay="400">
        </div>
    </section>
