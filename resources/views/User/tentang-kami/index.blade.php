...
@section('description', 'MENGENAL LEBIH JAUH BEACON ENGINEERING Kami menyediakan solusi berupa penyediaan perangkat
    telemetri')
...
@section('content')
                ...
                <div class="col-lg-6 col-md-9">
                    <div class="choose__img-wrap-five">
                        ...
                        <div class="img-shape">
                            ...
                            <img src="{{ asset('asset/img/images/testimonial_shape2.png') }}" alt=""
                ...
                <div class="col-lg-6">
                    <div class="choose__content-five">
                        <div class="section-title mb-30 tg-heading-subheading animation-style3">
                            <span class="sub-title" style="color: rgba(180, 4, 4, 0.75);">MENGENAL LEBIH JAUH BEACON
                                ENGINEERING</span>
                            <h2 class="title tg-element-title">Kami menyediakan solusi berupa penyediaan perangkat telemetri
                            </h2>
                        </div>
                        ...
                        <p style="text-align: justify;color:#2E2E4D">
                            Dengan keunggulan tersebut, perangkat telemetri dapat membantu berbagai bidang mulai dari
                            masalah keamanan air, klimatologi, hidrologi, irigasi, geothermal, hingga geoteknik.
                        </p>
                        <div class="about-bottom">
                            <a href="https://wa.me/628112632151" target="_blank" class="btn btn-two"
    ...
    <section id="about" class="call-back-area pt-120 pb-120">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-9">
                    <div class="komitmen__content-five">
                        ...
                        <p style="text-align: justify;color:#2E2E4D">melalui upaya profesional dan kreatif dalam
                            pengembangan teknologi telemetri pintar.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <ul class="list-wrap">
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <p style="text-align: justify;color:#2E2E4D">Memberikan kualitas produk dan layanan
                                        terbaik, dengan harga bersaing.</p>
                                </div>
                            </li>
                        </ul>
                        <ul class="list-wrap">
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <p style="text-align: justify;color:#2E2E4D">Mengelola bisnis berdasarkan SDM yang
                                        unggul, menggunakan teknologi terkini, dan membangun kerja sama yang menguntungkan.
                                    </p>
                                </div>
                            </li>
                        </ul>
                        <ul class="list-wrap">
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <p style="text-align: justify;color:#2E2E4D">Membangun riset dan inovasi berkelanjutan
                                        untuk menghasilkan produk yang sesuai dengan kebutuhan klien</p>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="blog-shape-wrap">
            <img src="{{ asset('asset/img/images/Komponen background (5).png') }}" style="opacity: 0.2" alt=""
                data-aos="fade-left" data-aos-delay="400">
            <img src="{{ asset('asset/img/images/Komponen background (3).png') }}" style="opacity: 0.2" alt=""
    ...
    <section class="team__area-four">
        <div class="" style="text-align: center;padding-bottom:100px">
            ...
            <h2 class="title">Dibalik Inovasi Telemetri <span style="color: rgba(180, 4, 4, 0.75);">Beacon</span>
                Engineering</h2>
        </div>
        <div class="container">
                            ...
                            <div class="team__thumb-four shine-animate">
                                @if ($tentangKami)
                                    @if ($tentangKami->gambar_direktur)
                                        <img src="{{ asset('storage/' . $tentangKami->gambar_direktur) }}"
                                            alt="Gambar Direktur">
                                    @endif
                                @else
                                    <p>Tidak ada gambar yang tersedia.</p>
                            ...
                            <div class="team__thumb-four shine-animate">
                                @if ($tentangKami)
                                    @if ($tentangKami->gambar_komisaris)
                                        <img src="{{ asset('storage/' . $tentangKami->gambar_komisaris) }}"
                                            alt="Gambar Komisaris">
                                    @endif
                                @else
                                    <p>Tidak ada gambar yang tersedia.</p>
                                @endif
                        ...
                        <div class="team__thumb-four shine-animate">
                            @if ($tentangKami)
                                @if ($tentangKami->gambar_administrasi)
                                    <img src="{{ asset('storage/' . $tentangKami->gambar_administrasi) }}"
                                        alt="Gambar Manager Administrasi">
                                @endif
                            @else
                                <p>Tidak ada gambar yang tersedia.</p>
                            @endif
                        ...
                        <div class="team__thumb-four shine-animate">
                            @if ($tentangKami)
                                @if ($tentangKami->gambar_hardware)
                                    <img src="{{ asset('storage/' . $tentangKami->gambar_hardware) }}"
                                        alt="Gambar Manager Hardware">
                                @endif
                            @else
                                <p>Tidak ada gambar yang tersedia.</p>
                            @endif
                        ...
                        <div class="team__thumb-four shine-animate">
                            @if ($tentangKami)
                                @if ($tentangKami->gambar_software)
                                    <img src="{{ asset('storage/' . $tentangKami->gambar_software) }}"
                                        alt="Gambar Manager Software">
                                @endif
                            @else
                                <p>Tidak ada gambar yang tersedia.</p>
                            @endif
