<div class="modal fade" id="tambahModelSolution" tabindex="-1" aria-labelledby="tambahModelSolutionLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahModelSolutionLabel">Tambah Solusi</h5>
