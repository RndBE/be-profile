                            ...
                            <form action="{{ route('projek.update', $projek->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input name="nama_projek" class="form-control mb-3" id="nama_projek" value="{{ old('nama_projek', $projek->nama_projek) }}">
                                        @error('nama_projek')
                                        ...
                                        <input name="lokasi" class="form-control mb-3" id="lokasi" value="{{ old('lokasi', $projek->lokasi) }}">
                                        @error('lokasi')
                                            <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                        @enderror

                                        <label for="website" class="form-label">Website</label>
                                        <input name="website" class="form-control mb-3" id="website" value="{{ old('website', $projek->website) }}">
                                        @error('website')
                                            <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                        @enderror

                                        <label for="waktu" class="form-label">Waktu</label>
                                        <input name="waktu" type="number" class="form-control mb-3" id="waktu" value="{{ old('waktu', $projek->waktu) }}">
                                        @error('waktu')
                                            <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
