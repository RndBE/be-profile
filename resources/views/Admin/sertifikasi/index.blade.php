...
@section('content')
        ...
        <div class="app-content">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"></h1>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModelSertifikasi">
                        Tambah
                    </button>
                </div>
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <table id="example" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse ($sertifikasi_atas as $index => $item)
                                            <tr>
                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                <td>
                                                    @if ($item->gambar_satu)
                                                ...
                                                <td>{{ $item->header ?? 'N/A' }}</td>
                                                <td>{{ $item->sub_header ?? 'N/A' }}</td>
                                                <td>
                                                    <a type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editSertifikasiModal{{ $item->id }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteSertifikasiModal{{ $item->id }}">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
    ...
    @include('Admin.sertifikasi-atas.create')
    @include('Admin.sertifikasi-atas.edit')
    @include('Admin.sertifikasi-atas.delete', ['sertifikasi_atas' => $sertifikasi_atas])
    <script>
